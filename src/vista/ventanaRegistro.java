...
public class ventanaRegistro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ImagenPersona.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/User (2).png"))); // NOI18N
        ...
        ImagenFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/Background.jpg"))); // NOI18N
    ...
    void limpiarTabla(){
        for(int i=0; i<=v1.tablaP.getRowCount();i++){
            v1.modeloT1.removeRow(i);
            i=i-1;
        }
        
        for(int j=0; j<=v1.tablaS.getRowCount();j++){
            v1.modeloT2.removeRow(j);
            j=j-1;
        }
    }
